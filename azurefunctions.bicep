...
// var cloudEndpointSuffix = environment == 'AzurePublicCloud' ? 'core.windows.net' :
//                         environment == 'AzureUSGovernmentCloud' ? 'core.usgovcloudapi.net' :
//                         environment == 'AzureChinaCloud' ? 'core.chinacloudapi.cn' :
//                         'core.cloudapi.de'
...
resource storageAccount 'Microsoft.Storage/storageAccounts@2021-08-01' = {
  ...
  // Storage Containers for Blob Storage
...
resource functionApp 'Microsoft.Web/sites@2020-12-01' = {
  ...
  // resource appInsights 'Microsoft.Insights/components/${appInsights.name}', '2015-05-01' = {
  //   name: 'myAppInsights'
  //   properties: {}
  //   // other properties for App Insights
  // }

// Outputs (avoid exposing secrets)
}
